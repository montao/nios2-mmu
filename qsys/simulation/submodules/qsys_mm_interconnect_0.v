...
module qsys_mm_interconnect_0 (
	...
	wire    [6:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> ram_mmu_s1_agent:cp_channel
	...
	wire          cmd_mux_006_src_valid;                                                     // cmd_mux_006:src_valid -> ram_mmu_s2_agent:cp_valid
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> ram_mmu_s2_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // ram_mmu_s2_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [6:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> ram_mmu_s2_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                             // cmd_mux_006:src_startofpacket -> ram_mmu_s2_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                               // cmd_mux_006:src_endofpacket -> ram_mmu_s2_agent:cp_endofpacket
	...
	wire          ram_mmu_s2_agent_rp_valid;                                                 // ram_mmu_s2_agent:rp_valid -> router_008:sink_valid
	wire  [103:0] ram_mmu_s2_agent_rp_data;                                                  // ram_mmu_s2_agent:rp_data -> router_008:sink_data
	wire          ram_mmu_s2_agent_rp_ready;                                                 // router_008:sink_ready -> ram_mmu_s2_agent:rp_ready
	wire          ram_mmu_s2_agent_rp_startofpacket;                                         // ram_mmu_s2_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          ram_mmu_s2_agent_rp_endofpacket;                                           // ram_mmu_s2_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          ram_mmu_s2_agent_rdata_fifo_src_valid;                                     // ram_mmu_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] ram_mmu_s2_agent_rdata_fifo_src_data;                                      // ram_mmu_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          ram_mmu_s2_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_006:in_0_ready -> ram_mmu_s2_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                         // avalon_st_adapter_006:out_0_valid -> ram_mmu_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                          // avalon_st_adapter_006:out_0_data -> ram_mmu_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                         // ram_mmu_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                         // avalon_st_adapter_006:out_0_error -> ram_mmu_s2_agent:rdata_fifo_sink_error
	...
	qsys_mm_interconnect_0_router_008 router_008 (
