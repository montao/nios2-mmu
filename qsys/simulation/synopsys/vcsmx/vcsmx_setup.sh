...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/qsys_mm_interconnect_0_rsp_demux_001.sv"                     -work rsp_demux_001                        
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/qsys_mm_interconnect_0_cmd_mux_001.sv"                       -work cmd_mux_001                          
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/qsys_mm_interconnect_0_router_008.sv"                        -work router_008                           
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/qsys_mm_interconnect_0_router_003.sv"                        -work router_003                           
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                     -work jtag_avalon_jtag_slave_agent_rsp_fifo
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                -work jtag_avalon_jtag_slave_agent         
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                         -work jtag_avalon_jtag_slave_agent         
  ...
  vlogan +v2k -sverilog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                           -work jtag_avalon_jtag_slave_translator    
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu_debug_slave_wrapper.v"                          -work cpu                                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu_debug_slave_tck.v"                              -work cpu                                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu_debug_slave_sysclk.v"                           -work cpu                                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu.vo"                                             -work cpu                                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu_mult_cell.v"                                    -work cpu                                  
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu_cpu_test_bench.v"                                   -work cpu                                  
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_uart.v"                                                 -work uart                                 
  ...
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_ram_mmu.v"                                              -work ram_mmu                              
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_jtag.v"                                                 -work jtag                                 
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/submodules/qsys_cpu.v"                                                  -work cpu                                  
