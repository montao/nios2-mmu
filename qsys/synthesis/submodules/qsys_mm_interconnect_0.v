...
module qsys_mm_interconnect_0 (
		...
		output wire [7:0]  ram_mmu_s1_address,                    //                      ram_mmu_s1.address
		output wire        ram_mmu_s1_write,                      //                                .write
		input  wire [31:0] ram_mmu_s1_readdata,                   //                                .readdata
		output wire [31:0] ram_mmu_s1_writedata,                  //                                .writedata
		output wire [3:0]  ram_mmu_s1_byteenable,                 //                                .byteenable
		output wire        ram_mmu_s1_chipselect,                 //                                .chipselect
		output wire        ram_mmu_s1_clken,                      //                                .clken
		output wire [7:0]  ram_mmu_s2_address,                    //                      ram_mmu_s2.address
		output wire        ram_mmu_s2_write,                      //                                .write
		input  wire [31:0] ram_mmu_s2_readdata,                   //                                .readdata
		output wire [31:0] ram_mmu_s2_writedata,                  //                                .writedata
		output wire [3:0]  ram_mmu_s2_byteenable,                 //                                .byteenable
		output wire        ram_mmu_s2_chipselect,                 //                                .chipselect
		output wire        ram_mmu_s2_clken,                      //                                .clken
	...
	wire  [103:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> cpu_debug_mem_slave_agent:cp_data
	...
	wire   [31:0] ram_mmu_s1_agent_m0_readdata;                                              // ram_mmu_s1_translator:uav_readdata -> ram_mmu_s1_agent:m0_readdata
	wire          ram_mmu_s1_agent_m0_waitrequest;                                           // ram_mmu_s1_translator:uav_waitrequest -> ram_mmu_s1_agent:m0_waitrequest
	wire          ram_mmu_s1_agent_m0_debugaccess;                                           // ram_mmu_s1_agent:m0_debugaccess -> ram_mmu_s1_translator:uav_debugaccess
	wire   [27:0] ram_mmu_s1_agent_m0_address;                                               // ram_mmu_s1_agent:m0_address -> ram_mmu_s1_translator:uav_address
	wire    [3:0] ram_mmu_s1_agent_m0_byteenable;                                            // ram_mmu_s1_agent:m0_byteenable -> ram_mmu_s1_translator:uav_byteenable
	wire          ram_mmu_s1_agent_m0_read;                                                  // ram_mmu_s1_agent:m0_read -> ram_mmu_s1_translator:uav_read
	wire          ram_mmu_s1_agent_m0_readdatavalid;                                         // ram_mmu_s1_translator:uav_readdatavalid -> ram_mmu_s1_agent:m0_readdatavalid
	wire          ram_mmu_s1_agent_m0_lock;                                                  // ram_mmu_s1_agent:m0_lock -> ram_mmu_s1_translator:uav_lock
	wire   [31:0] ram_mmu_s1_agent_m0_writedata;                                             // ram_mmu_s1_agent:m0_writedata -> ram_mmu_s1_translator:uav_writedata
	wire          ram_mmu_s1_agent_m0_write;                                                 // ram_mmu_s1_agent:m0_write -> ram_mmu_s1_translator:uav_write
	wire    [2:0] ram_mmu_s1_agent_m0_burstcount;                                            // ram_mmu_s1_agent:m0_burstcount -> ram_mmu_s1_translator:uav_burstcount
	wire          ram_mmu_s1_agent_rf_source_valid;                                          // ram_mmu_s1_agent:rf_source_valid -> ram_mmu_s1_agent_rsp_fifo:in_valid
	wire  [104:0] ram_mmu_s1_agent_rf_source_data;                                           // ram_mmu_s1_agent:rf_source_data -> ram_mmu_s1_agent_rsp_fifo:in_data
	wire          ram_mmu_s1_agent_rf_source_ready;                                          // ram_mmu_s1_agent_rsp_fifo:in_ready -> ram_mmu_s1_agent:rf_source_ready
	wire          ram_mmu_s1_agent_rf_source_startofpacket;                                  // ram_mmu_s1_agent:rf_source_startofpacket -> ram_mmu_s1_agent_rsp_fifo:in_startofpacket
	wire          ram_mmu_s1_agent_rf_source_endofpacket;                                    // ram_mmu_s1_agent:rf_source_endofpacket -> ram_mmu_s1_agent_rsp_fifo:in_endofpacket
	wire          ram_mmu_s1_agent_rsp_fifo_out_valid;                                       // ram_mmu_s1_agent_rsp_fifo:out_valid -> ram_mmu_s1_agent:rf_sink_valid
	wire  [104:0] ram_mmu_s1_agent_rsp_fifo_out_data;                                        // ram_mmu_s1_agent_rsp_fifo:out_data -> ram_mmu_s1_agent:rf_sink_data
	wire          ram_mmu_s1_agent_rsp_fifo_out_ready;                                       // ram_mmu_s1_agent:rf_sink_ready -> ram_mmu_s1_agent_rsp_fifo:out_ready
	wire          ram_mmu_s1_agent_rsp_fifo_out_startofpacket;                               // ram_mmu_s1_agent_rsp_fifo:out_startofpacket -> ram_mmu_s1_agent:rf_sink_startofpacket
	wire          ram_mmu_s1_agent_rsp_fifo_out_endofpacket;                                 // ram_mmu_s1_agent_rsp_fifo:out_endofpacket -> ram_mmu_s1_agent:rf_sink_endofpacket
	wire          cmd_mux_002_src_valid;                                                     // cmd_mux_002:src_valid -> ram_mmu_s1_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> ram_mmu_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                                     // ram_mmu_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [7:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> ram_mmu_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                             // cmd_mux_002:src_startofpacket -> ram_mmu_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                               // cmd_mux_002:src_endofpacket -> ram_mmu_s1_agent:cp_endofpacket
	...
	wire    [7:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sdram_s1_agent:cp_channel
	...
	wire  [103:0] cmd_mux_004_src_data;                                                      // cmd_mux_004:src_data -> timer_s1_agent:cp_data
	...
	wire    [7:0] cmd_mux_005_src_channel;                                                   // cmd_mux_005:src_channel -> uart_s1_agent:cp_channel
	...
	wire  [103:0] cmd_mux_006_src_data;                                                      // cmd_mux_006:src_data -> timer_0_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                     // timer_0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                   // cmd_mux_006:src_channel -> timer_0_s1_agent:cp_channel
	...
	wire   [31:0] ram_mmu_s2_agent_m0_readdata;                                              // ram_mmu_s2_translator:uav_readdata -> ram_mmu_s2_agent:m0_readdata
	wire          ram_mmu_s2_agent_m0_waitrequest;                                           // ram_mmu_s2_translator:uav_waitrequest -> ram_mmu_s2_agent:m0_waitrequest
	wire          ram_mmu_s2_agent_m0_debugaccess;                                           // ram_mmu_s2_agent:m0_debugaccess -> ram_mmu_s2_translator:uav_debugaccess
	wire   [27:0] ram_mmu_s2_agent_m0_address;                                               // ram_mmu_s2_agent:m0_address -> ram_mmu_s2_translator:uav_address
	wire    [3:0] ram_mmu_s2_agent_m0_byteenable;                                            // ram_mmu_s2_agent:m0_byteenable -> ram_mmu_s2_translator:uav_byteenable
	wire          ram_mmu_s2_agent_m0_read;                                                  // ram_mmu_s2_agent:m0_read -> ram_mmu_s2_translator:uav_read
	wire          ram_mmu_s2_agent_m0_readdatavalid;                                         // ram_mmu_s2_translator:uav_readdatavalid -> ram_mmu_s2_agent:m0_readdatavalid
	wire          ram_mmu_s2_agent_m0_lock;                                                  // ram_mmu_s2_agent:m0_lock -> ram_mmu_s2_translator:uav_lock
	wire   [31:0] ram_mmu_s2_agent_m0_writedata;                                             // ram_mmu_s2_agent:m0_writedata -> ram_mmu_s2_translator:uav_writedata
	wire          ram_mmu_s2_agent_m0_write;                                                 // ram_mmu_s2_agent:m0_write -> ram_mmu_s2_translator:uav_write
	wire    [2:0] ram_mmu_s2_agent_m0_burstcount;                                            // ram_mmu_s2_agent:m0_burstcount -> ram_mmu_s2_translator:uav_burstcount
	wire          ram_mmu_s2_agent_rf_source_valid;                                          // ram_mmu_s2_agent:rf_source_valid -> ram_mmu_s2_agent_rsp_fifo:in_valid
	wire  [104:0] ram_mmu_s2_agent_rf_source_data;                                           // ram_mmu_s2_agent:rf_source_data -> ram_mmu_s2_agent_rsp_fifo:in_data
	wire          ram_mmu_s2_agent_rf_source_ready;                                          // ram_mmu_s2_agent_rsp_fifo:in_ready -> ram_mmu_s2_agent:rf_source_ready
	wire          ram_mmu_s2_agent_rf_source_startofpacket;                                  // ram_mmu_s2_agent:rf_source_startofpacket -> ram_mmu_s2_agent_rsp_fifo:in_startofpacket
	wire          ram_mmu_s2_agent_rf_source_endofpacket;                                    // ram_mmu_s2_agent:rf_source_endofpacket -> ram_mmu_s2_agent_rsp_fifo:in_endofpacket
	wire          ram_mmu_s2_agent_rsp_fifo_out_valid;                                       // ram_mmu_s2_agent_rsp_fifo:out_valid -> ram_mmu_s2_agent:rf_sink_valid
	wire  [104:0] ram_mmu_s2_agent_rsp_fifo_out_data;                                        // ram_mmu_s2_agent_rsp_fifo:out_data -> ram_mmu_s2_agent:rf_sink_data
	wire          ram_mmu_s2_agent_rsp_fifo_out_ready;                                       // ram_mmu_s2_agent:rf_sink_ready -> ram_mmu_s2_agent_rsp_fifo:out_ready
	wire          ram_mmu_s2_agent_rsp_fifo_out_startofpacket;                               // ram_mmu_s2_agent_rsp_fifo:out_startofpacket -> ram_mmu_s2_agent:rf_sink_startofpacket
	wire          ram_mmu_s2_agent_rsp_fifo_out_endofpacket;                                 // ram_mmu_s2_agent_rsp_fifo:out_endofpacket -> ram_mmu_s2_agent:rf_sink_endofpacket
	wire          cmd_mux_007_src_valid;                                                     // cmd_mux_007:src_valid -> ram_mmu_s2_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                      // cmd_mux_007:src_data -> ram_mmu_s2_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                     // ram_mmu_s2_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                   // cmd_mux_007:src_channel -> ram_mmu_s2_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                             // cmd_mux_007:src_startofpacket -> ram_mmu_s2_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                               // cmd_mux_007:src_endofpacket -> ram_mmu_s2_agent:cp_endofpacket
	...
	wire  [103:0] cpu_debug_mem_slave_agent_rp_data;                                         // cpu_debug_mem_slave_agent:rp_data -> router_003:sink_data
	...
	wire          ram_mmu_s1_agent_rp_valid;                                                 // ram_mmu_s1_agent:rp_valid -> router_004:sink_valid
	wire  [103:0] ram_mmu_s1_agent_rp_data;                                                  // ram_mmu_s1_agent:rp_data -> router_004:sink_data
	wire          ram_mmu_s1_agent_rp_ready;                                                 // router_004:sink_ready -> ram_mmu_s1_agent:rp_ready
	wire          ram_mmu_s1_agent_rp_startofpacket;                                         // ram_mmu_s1_agent:rp_startofpacket -> router_004:sink_startofpacket
	wire          ram_mmu_s1_agent_rp_endofpacket;                                           // ram_mmu_s1_agent:rp_endofpacket -> router_004:sink_endofpacket
	...
	wire  [103:0] timer_s1_agent_rp_data;                                                    // timer_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [103:0] timer_0_s1_agent_rp_data;                                                  // timer_0_s1_agent:rp_data -> router_008:sink_data
	...
	wire          ram_mmu_s2_agent_rp_valid;                                                 // ram_mmu_s2_agent:rp_valid -> router_009:sink_valid
	wire  [103:0] ram_mmu_s2_agent_rp_data;                                                  // ram_mmu_s2_agent:rp_data -> router_009:sink_data
	wire          ram_mmu_s2_agent_rp_ready;                                                 // router_009:sink_ready -> ram_mmu_s2_agent:rp_ready
	wire          ram_mmu_s2_agent_rp_startofpacket;                                         // ram_mmu_s2_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          ram_mmu_s2_agent_rp_endofpacket;                                           // ram_mmu_s2_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          cmd_demux_001_src2_valid;                                                  // cmd_demux_001:src2_valid -> cmd_mux_007:sink0_valid
	wire  [103:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_007:sink0_data
	wire          cmd_demux_001_src2_ready;                                                  // cmd_mux_007:sink0_ready -> cmd_demux_001:src2_ready
	wire    [7:0] cmd_demux_001_src2_channel;                                                // cmd_demux_001:src2_channel -> cmd_mux_007:sink0_channel
	wire          cmd_demux_001_src2_startofpacket;                                          // cmd_demux_001:src2_startofpacket -> cmd_mux_007:sink0_startofpacket
	wire          cmd_demux_001_src2_endofpacket;                                            // cmd_demux_001:src2_endofpacket -> cmd_mux_007:sink0_endofpacket
	...
	wire          rsp_demux_007_src0_valid;                                                  // rsp_demux_007:src0_valid -> rsp_mux_001:sink2_valid
	wire  [103:0] rsp_demux_007_src0_data;                                                   // rsp_demux_007:src0_data -> rsp_mux_001:sink2_data
	wire          rsp_demux_007_src0_ready;                                                  // rsp_mux_001:sink2_ready -> rsp_demux_007:src0_ready
	wire    [7:0] rsp_demux_007_src0_channel;                                                // rsp_demux_007:src0_channel -> rsp_mux_001:sink2_channel
	wire          rsp_demux_007_src0_startofpacket;                                          // rsp_demux_007:src0_startofpacket -> rsp_mux_001:sink2_startofpacket
	wire          rsp_demux_007_src0_endofpacket;                                            // rsp_demux_007:src0_endofpacket -> rsp_mux_001:sink2_endofpacket
	...
	wire          ram_mmu_s1_agent_rdata_fifo_src_valid;                                     // ram_mmu_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] ram_mmu_s1_agent_rdata_fifo_src_data;                                      // ram_mmu_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          ram_mmu_s1_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_002:in_0_ready -> ram_mmu_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_002_out_0_valid;                                         // avalon_st_adapter_002:out_0_valid -> ram_mmu_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_002_out_0_data;                                          // avalon_st_adapter_002:out_0_data -> ram_mmu_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_002_out_0_ready;                                         // ram_mmu_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_002:out_0_ready
	wire    [0:0] avalon_st_adapter_002_out_0_error;                                         // avalon_st_adapter_002:out_0_error -> ram_mmu_s1_agent:rdata_fifo_sink_error
	...
	wire          ram_mmu_s2_agent_rdata_fifo_src_valid;                                     // ram_mmu_s2_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] ram_mmu_s2_agent_rdata_fifo_src_data;                                      // ram_mmu_s2_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          ram_mmu_s2_agent_rdata_fifo_src_ready;                                     // avalon_st_adapter_007:in_0_ready -> ram_mmu_s2_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                         // avalon_st_adapter_007:out_0_valid -> ram_mmu_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                          // avalon_st_adapter_007:out_0_data -> ram_mmu_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                         // ram_mmu_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                         // avalon_st_adapter_007:out_0_error -> ram_mmu_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ram_mmu_s1_translator (
		.clk                    (clk_50_clk_clk),                        //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ram_mmu_s1_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (ram_mmu_s1_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (ram_mmu_s1_agent_m0_read),              //                         .read
		.uav_write              (ram_mmu_s1_agent_m0_write),             //                         .write
		.uav_waitrequest        (ram_mmu_s1_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (ram_mmu_s1_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (ram_mmu_s1_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (ram_mmu_s1_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (ram_mmu_s1_agent_m0_writedata),         //                         .writedata
		.uav_lock               (ram_mmu_s1_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (ram_mmu_s1_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (ram_mmu_s1_address),                    //      avalon_anti_slave_0.address
		.av_write               (ram_mmu_s1_write),                      //                         .write
		.av_readdata            (ram_mmu_s1_readdata),                   //                         .readdata
		.av_writedata           (ram_mmu_s1_writedata),                  //                         .writedata
		.av_byteenable          (ram_mmu_s1_byteenable),                 //                         .byteenable
		.av_chipselect          (ram_mmu_s1_chipselect),                 //                         .chipselect
		.av_clken               (ram_mmu_s1_clken),                      //                         .clken
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) ram_mmu_s2_translator (
		.clk                    (clk_50_clk_clk),                        //                      clk.clk
		.reset                  (cpu_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (ram_mmu_s2_agent_m0_address),           // avalon_universal_slave_0.address
		.uav_burstcount         (ram_mmu_s2_agent_m0_burstcount),        //                         .burstcount
		.uav_read               (ram_mmu_s2_agent_m0_read),              //                         .read
		.uav_write              (ram_mmu_s2_agent_m0_write),             //                         .write
		.uav_waitrequest        (ram_mmu_s2_agent_m0_waitrequest),       //                         .waitrequest
		.uav_readdatavalid      (ram_mmu_s2_agent_m0_readdatavalid),     //                         .readdatavalid
		.uav_byteenable         (ram_mmu_s2_agent_m0_byteenable),        //                         .byteenable
		.uav_readdata           (ram_mmu_s2_agent_m0_readdata),          //                         .readdata
		.uav_writedata          (ram_mmu_s2_agent_m0_writedata),         //                         .writedata
		.uav_lock               (ram_mmu_s2_agent_m0_lock),              //                         .lock
		.uav_debugaccess        (ram_mmu_s2_agent_m0_debugaccess),       //                         .debugaccess
		.av_address             (ram_mmu_s2_address),                    //      avalon_anti_slave_0.address
		.av_write               (ram_mmu_s2_write),                      //                         .write
		.av_readdata            (ram_mmu_s2_readdata),                   //                         .readdata
		.av_writedata           (ram_mmu_s2_writedata),                  //                         .writedata
		.av_byteenable          (ram_mmu_s2_byteenable),                 //                         .byteenable
		.av_chipselect          (ram_mmu_s2_chipselect),                 //                         .chipselect
		.av_clken               (ram_mmu_s2_clken),                      //                         .clken
		.av_read                (),                                      //              (terminated)
		.av_begintransfer       (),                                      //              (terminated)
		.av_beginbursttransfer  (),                                      //              (terminated)
		.av_burstcount          (),                                      //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_50_clk_clk),                              //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (ram_mmu_s1_agent_m0_address),                 //              m0.address
		.m0_burstcount           (ram_mmu_s1_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (ram_mmu_s1_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (ram_mmu_s1_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (ram_mmu_s1_agent_m0_lock),                    //                .lock
		.m0_readdata             (ram_mmu_s1_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (ram_mmu_s1_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (ram_mmu_s1_agent_m0_read),                    //                .read
		.m0_waitrequest          (ram_mmu_s1_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (ram_mmu_s1_agent_m0_writedata),               //                .writedata
		.m0_write                (ram_mmu_s1_agent_m0_write),                   //                .write
		.rp_endofpacket          (ram_mmu_s1_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (ram_mmu_s1_agent_rp_ready),                   //                .ready
		.rp_valid                (ram_mmu_s1_agent_rp_valid),                   //                .valid
		.rp_data                 (ram_mmu_s1_agent_rp_data),                    //                .data
		.rp_startofpacket        (ram_mmu_s1_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (ram_mmu_s1_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (ram_mmu_s1_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (ram_mmu_s1_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (ram_mmu_s1_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (ram_mmu_s1_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (ram_mmu_s1_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (ram_mmu_s1_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (ram_mmu_s1_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (ram_mmu_s1_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (ram_mmu_s1_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_002_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_002_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_002_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_002_out_0_error),           //                .error
		.rdata_fifo_src_ready    (ram_mmu_s1_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ram_mmu_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (ram_mmu_s1_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ram_mmu_s1_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                              //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (ram_mmu_s1_agent_rf_source_data),             //        in.data
		.in_valid          (ram_mmu_s1_agent_rf_source_valid),            //          .valid
		.in_ready          (ram_mmu_s1_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ram_mmu_s1_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ram_mmu_s1_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ram_mmu_s1_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ram_mmu_s1_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ram_mmu_s1_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ram_mmu_s1_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ram_mmu_s1_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_50_clk_clk),                              //             clk.clk
		.reset                   (cpu_reset_reset_bridge_in_reset_reset),       //       clk_reset.reset
		.m0_address              (ram_mmu_s2_agent_m0_address),                 //              m0.address
		.m0_burstcount           (ram_mmu_s2_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (ram_mmu_s2_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (ram_mmu_s2_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (ram_mmu_s2_agent_m0_lock),                    //                .lock
		.m0_readdata             (ram_mmu_s2_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (ram_mmu_s2_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (ram_mmu_s2_agent_m0_read),                    //                .read
		.m0_waitrequest          (ram_mmu_s2_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (ram_mmu_s2_agent_m0_writedata),               //                .writedata
		.m0_write                (ram_mmu_s2_agent_m0_write),                   //                .write
		.rp_endofpacket          (ram_mmu_s2_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (ram_mmu_s2_agent_rp_ready),                   //                .ready
		.rp_valid                (ram_mmu_s2_agent_rp_valid),                   //                .valid
		.rp_data                 (ram_mmu_s2_agent_rp_data),                    //                .data
		.rp_startofpacket        (ram_mmu_s2_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (ram_mmu_s2_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (ram_mmu_s2_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (ram_mmu_s2_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (ram_mmu_s2_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (ram_mmu_s2_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (ram_mmu_s2_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (ram_mmu_s2_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (ram_mmu_s2_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (ram_mmu_s2_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (ram_mmu_s2_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),           // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),           //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),            //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),           //                .error
		.rdata_fifo_src_ready    (ram_mmu_s2_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (ram_mmu_s2_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (ram_mmu_s2_agent_rdata_fifo_src_data),        //                .data
		.m0_response             (2'b00),                                       //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                         //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) ram_mmu_s2_agent_rsp_fifo (
		.clk               (clk_50_clk_clk),                              //       clk.clk
		.reset             (cpu_reset_reset_bridge_in_reset_reset),       // clk_reset.reset
		.in_data           (ram_mmu_s2_agent_rf_source_data),             //        in.data
		.in_valid          (ram_mmu_s2_agent_rf_source_valid),            //          .valid
		.in_ready          (ram_mmu_s2_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (ram_mmu_s2_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (ram_mmu_s2_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (ram_mmu_s2_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (ram_mmu_s2_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (ram_mmu_s2_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (ram_mmu_s2_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (ram_mmu_s2_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
		.csr_address       (2'b00),                                       // (terminated)
		.csr_read          (1'b0),                                        // (terminated)
		.csr_write         (1'b0),                                        // (terminated)
		.csr_readdata      (),                                            // (terminated)
	...
	qsys_mm_interconnect_0_router_002 router_004 (
		.sink_ready         (ram_mmu_s1_agent_rp_ready),             //      sink.ready
		.sink_valid         (ram_mmu_s1_agent_rp_valid),             //          .valid
		.sink_data          (ram_mmu_s1_agent_rp_data),              //          .data
		.sink_startofpacket (ram_mmu_s1_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (ram_mmu_s1_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_mm_interconnect_0_router_003 router_005 (
	...
	qsys_mm_interconnect_0_router_009 router_009 (
		.sink_ready         (ram_mmu_s2_agent_rp_ready),             //      sink.ready
		.sink_valid         (ram_mmu_s2_agent_rp_valid),             //          .valid
		.sink_data          (ram_mmu_s2_agent_rp_data),              //          .data
		.sink_startofpacket (ram_mmu_s2_agent_rp_startofpacket),     //          .startofpacket
		.sink_endofpacket   (ram_mmu_s2_agent_rp_endofpacket),       //          .endofpacket
		.clk                (clk_50_clk_clk),                        //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_50_clk_clk),                        //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	qsys_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		...
		.sink2_ready         (rsp_demux_007_src0_ready),              //     sink2.ready
		.sink2_valid         (rsp_demux_007_src0_valid),              //          .valid
		.sink2_channel       (rsp_demux_007_src0_channel),            //          .channel
		.sink2_data          (rsp_demux_007_src0_data),               //          .data
		.sink2_startofpacket (rsp_demux_007_src0_startofpacket),      //          .startofpacket
		.sink2_endofpacket   (rsp_demux_007_src0_endofpacket)         //          .endofpacket
	);
	...
	qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                        // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ram_mmu_s1_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (ram_mmu_s1_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (ram_mmu_s1_agent_rdata_fifo_src_ready), //         .ready
	...
	qsys_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_50_clk_clk),                        // in_clk_0.clk
		.in_rst_0_reset (cpu_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (ram_mmu_s2_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (ram_mmu_s2_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (ram_mmu_s2_agent_rdata_fifo_src_ready), //         .ready
